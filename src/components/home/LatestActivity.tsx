            ...
            >
              ...
              <Box sx={{ mt: 2, display: "flex", alignItems: "center" }}>
                <img
                  ...
                  height={28}
                  alt="invoice.pdf"
                  src="/demo/materialize-mui-react-nextjs-admin-template/demo-3/images/icons/file-icons/pdf.png"
                />
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              ...
              <Typography variant="body2" sx={{ color: "text.primary" }}>
                ...
                Possimus quos, voluptates voluptas rem.
              </Typography>
              {/* <Divider sx={{ my: theme => {theme.spacing(3)} !important }} /> */}
              <Box sx={{ display: "flex", justifyContent: "space-between" }}>
                <Box sx={{ display: "flex" }}>
                  <Avatar
                    src="/demo/materialize-mui-react-nextjs-admin-template/demo-3/images/avatars/2.png"
            ...
            <TimelineContent>
              ...
              >
                <ImgShoe
                  ...
                  height="85"
                  alt="Shoe img"
                  src="/demo/materialize-mui-react-nextjs-admin-template/demo-3/images/misc/shoe.jpeg"
                />
                <Box sx={{ ml: { sm: 3, xs: 0 } }}>
                  <Box
                    sx={{
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              ...
              <Box sx={{ display: "flex", alignItems: "center" }}>
                <Avatar
                  src="/demo/materialize-mui-react-nextjs-admin-template/demo-3/images/avatars/1.png"
                  sx={{ width: "2rem", height: "2rem", mr: 2 }}
                />
                <Typography variant="subtitle2" sx={{ fontWeight: 600 }}>
                  John Doe (Client)
